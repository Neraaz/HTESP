...
def main():
    ...
    with open("log", "w") as flog:
        ...
        flog.write("\n")
        flog.write("\n")
        flog.write("To support development activities, please cite the following paper and the papers referenced therein for calculations conducted.\n")
        flog.write("\n")
        flog.write("N. K. Nepal, P. C. Canfield, and L.-L. Wang, HTESP (high-throughput electronic structure package): a package for the high-throughput ab initio calculations (2024), arXiv:2406.04537 [physics.comp-ph]\n")
        flog.write("\n")
        flog.write("_____________________________________________________________________________________________________________________________________\n")
        flog.write("\n")
        flog.write("\n")

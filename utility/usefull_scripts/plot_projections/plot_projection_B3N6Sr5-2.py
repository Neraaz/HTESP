...
logical1 = np.logical_and(proj1 < 0.4,proj1 > 0.2)
logical2 = np.logical_and(proj2 < 0.4,proj2 > 0.2)
logical3 = np.logical_and(proj3 < 0.4,proj3 > 0.2)
proj5[logical1] = 0.25
proj5[logical2] = 0.50
proj5[logical3] = 0.75
print(proj5)
#proj5[np.where(proj4 > 0.5)] = 1.0
cmap = matplotlib.colors.ListedColormap(['red', 'blue', 'green', 'k'])

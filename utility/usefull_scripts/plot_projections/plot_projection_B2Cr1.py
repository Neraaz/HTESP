...
filename_phonon_freq = 'B2Cr1.freq.gp' #phonon dispersion data in gnu format obtained from QE phonon calculations.
filename_scf = 'scf.in'
...
plt.plot([ks[6], ks[6]], [miny, maxy], 'k--', lw=2) 
plt.plot([ks[7], ks[7]], [miny, maxy], 'k--', lw=2) 
plt.plot([ks[8], ks[8]], [miny, maxy], 'k--', lw=2) 
...
plt.xticks(ks, [r'$\Gamma$', 'M', 'K', r'$\Gamma$', 'A', 'L', 'H', 'A|L', '', 'M|K','', 'H'])    
plt.ylim(miny,maxy)
plt.xlim(ks[0],ks[-1])
